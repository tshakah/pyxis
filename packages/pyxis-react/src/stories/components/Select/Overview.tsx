...
const tableClassBody: TableRow[] = [
  ...
  [
    <CopyableCode text="form-field--with-dropdown" key={shortid.generate()} />,
    'State Modifier',
    <code>div</code>,
  ...
  [
    <CopyableCode text="form-field__dropdown-wrapper" key={shortid.generate()} />,
    'Dropdown Class',
    <code>div</code>,
    'Use it along with custom select (not native)',
  ],
  [
    <CopyableCode text="form-field__dropdown-wrapper--small" key={shortid.generate()} />,
    'Dropdown Modifier',
    <code>div</code>,
    '-',
  ],
  [
    <CopyableCode text="form-field__dropdown" key={shortid.generate()} />,
    'Dropdown Class',
    <code>div</code>,
    'Use it along with custom select (not native)',
  ],
  [
    <CopyableCode text="form-field__dropdown__item" key={shortid.generate()} />,
    'Item Class',
    <code>div</code>,
    'Use it along with custom select (not native)',
  ],
  [
    <CopyableCode text="form-field__dropdown__item--active" key={shortid.generate()} />,
    'Item Modifier',
    <code>div</code>,
    '-',
  ],
