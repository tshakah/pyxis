    ...
    <div className="form-item">
      ...
      <div className="form-card-group">
        <label className="form-card form-card--large">
          ...
          <input type="radio" name="default large" className="form-control__radio"/>
        </label>
        <label className="form-card form-card--large form-card--checked">
          ...
          <input type="radio" name="default large" className="form-control__radio" defaultChecked/>
        </label>
      </div>
    </div>
    ...
    <div className="form-item">
      ...
      <div className="form-card-group">
        <label className="form-card form-card--large">
          ...
          <input type="radio" name="text large" className="form-control__radio"/>
        </label>
        ...
        <label className="form-card form-card--large form-card--checked">
          ...
          <input type="radio" name="text large" className="form-control__radio" defaultChecked/>
        </label>
      </div>
    </div>
    ...
    <div className="form-item">
      ...
      <div className="form-card-group">
        <label className="form-card form-card--large form-card--error">
          ...
          <input type="radio" name="error large" className="form-control__radio" />
        </label>
        ...
        <label className="form-card form-card--large form-card--error form-card--checked">
          ...
          <input type="radio" name="error large" className="form-control__radio" defaultChecked/>
        </label>
    ...
    <div className="form-item">
      ...
      <div className="form-card-group">
        <label className="form-card form-card--large form-card--disabled">
          ...
          <input type="radio" name="disabled large" className="form-control__radio" disabled/>
        </label>
        ...
        <label className="form-card form-card--large form-card--disabled form-card--checked">
          ...
          <input type="radio" name="disabled large" className="form-control__radio" defaultChecked disabled/>
        </label>
      </div>
    </div>
    ...
    <div className="form-item">
      ...
      <div className="form-card-group">
        <label className="form-card">
          ...
          <input type="radio" name="icon default" className="form-control__radio"/>
        </label>
        ...
        <label className="form-card form-card--checked">
          ...
          <input type="radio" name="icon default" className="form-control__radio" defaultChecked />
        </label>
      </div>
    </div>
    ...
    <div className="form-item">
      ...
      <div className="form-card-group">
        <label className="form-card">
          ...
          <input type="radio" name="icon text" className="form-control__radio"/>
        </label>
    ...
    <div className="form-item">
      ...
      <div className="form-card-group">
        <label className="form-card form-card--error">
          ...
          <input type="radio" name="disabled icon" className="form-control__radio"/>
        </label>
        ...
        <label className="form-card form-card--disabled">
          ...
          <input type="radio" name="disabled icon" className="form-control__radio" disabled/>
        </label>
      </div>
    </div>
    ...
    <div className="form-item">
      ...
      <div className="form-card-group">
        <label className="form-card">
          ...
          <input type="radio" name="price default" className="form-control__radio"/>
        </label>
        <label className="form-card form-card--checked">
          <span className="form-card__content-wrapper">
            <span className="form-card__title">Title card</span>
          ...
          <span className="form-card__addon">€ 1.000,00</span>
          <input type="radio" name="price default" className="form-control__radio" defaultChecked />
        </label>
      </div>
    </div>
    ...
    <div className="form-item">
      ...
      <div className="form-card-group">
        <label className="form-card">
          ...
          <span className="form-card__addon">€ 1.000,00</span>
          <input type="radio" name="text default" className="form-control__radio"/>
        </label>
        ...
        <label className="form-card">
          ...
          <span className="form-card__addon">€ 1.000,00</span>
          <input type="radio" name="text price" className="form-control__radio" />
        </label>
      </div>
    </div>
    ...
    <div className="form-item">
      ...
      <div className="form-card-group">
        <label className="form-card form-card--error">
          ...
          <span className="form-card__addon">€ 1.000,00</span>
          <input type="radio" name="variant price" className="form-control__radio"/>
        </label>
        ...
        <label className="form-card form-card--disabled">
          ...
          <span className="form-card__addon">€ 1.000,00</span>
          <input type="radio" name="variant price" className="form-control__radio" disabled/>
        </label>
      </div>
    </div>
    ...
    <div className="form-item">
      ...
      <div className="form-card-group">
        <label className="form-card">
          ...
          <input type="radio" name="text" className="form-control__radio"/>
        </label>
    ...
    <div className="form-item">
      ...
      <div className="form-card-group">
        <label className="form-card form-card--error">
          ...
          <input type="radio" name="variant" className="form-control__radio"/>
        </label>
        ...
        <label className="form-card form-card--disabled">
          ...
          <input type="radio" name="variant" className="form-control__radio" disabled/>
        </label>
      </div>
    </div>
  </div>
