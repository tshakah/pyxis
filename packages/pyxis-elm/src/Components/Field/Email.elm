module Components.Field.Email exposing
    ( Model
    , create
    , iconAddon
    , textAddon
...
{-| Represent the messages which the Input can handle.
-}
type Msg
    = OnInput String
    | OnFocus
...
{-| Creates an Input of type Email.
-}
...
{-| Sets a default value to the Input.
-}
...
{-| Add a Validation set of rules to the Input.
-}
